...
function changeImage(baseImageId) {
    ...
    closeButton.onclick = function() {
        ...
        const image2_2 = document.getElementById(`${baseImageId}-2`);
        image2_2.hidden = true;
        // image2_2.classList.add('hidden');

        showAdditionalButtons(); // 显示额外按钮
    };
    ...
    function showAdditionalButtons() {
        ...
        backButton.onclick = function() {
            ...
            const image_1 = document.getElementById(`${baseImageId}-1`);
            image_1.hidden = true;
